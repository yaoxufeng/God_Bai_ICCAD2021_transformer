...
% ==================== table2 =====================
% batch matrix multiplication and softmax in MHA
\begin{table*}[htbp]
...
% ==================== table3 =====================
% dynamic programming for operator fusion on DETR
\begin{table*}[htbp]
    ...
    Ansor    &     9                &   [6, 6, 6, 6, 6, 12, 12, 6, 6]  &       13   & \vtop{\hbox{\strut [18, 6, 6, 6, 6, 18,}\hbox{\strut 18, 6, 6, 6, 6, 6, 6]}}  &           22               &     \vtop{\hbox{\strut [18, 6, 6, 6, 6, 19, 19, }\hbox{\strut 6, 6, 6, 6, 6, 6, 6,}\hbox{\strut 6, 6, 13, 13, 6, 6, 6, 6}}                 &        10000            \\ \hline
    AutoGTCO &              &                        &                      &                     &                          &                        &       8790             \\ \hline
    \end{tabular}
    }
\end{table*}

\vtop{\hbox{\strut [18, 6, 6, 6, 6, 19, 19, }\hbox{\strut 6, 6, 6, 6, 6, 6, 6,}\hbox{\strut 6, 6, 13, 13, 6, 6, 6, 6}}
...
% ==================== table5 =====================
% image recognition with transformers acceleration
% \begin{table}[htbp]
%     \caption{image recognition with transformers acceleration}
%     \label{transformer_cls}
%     \centering
%     \scalebox{0.85}{
